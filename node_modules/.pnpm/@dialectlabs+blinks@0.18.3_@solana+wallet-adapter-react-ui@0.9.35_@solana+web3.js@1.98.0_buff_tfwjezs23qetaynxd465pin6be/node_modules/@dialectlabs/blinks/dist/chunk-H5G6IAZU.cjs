...
var useLayoutPropNormalizer = ({
  ...
  return {
    ...
    websiteText: _nullishCoalesce(_nullishCoalesce(props.websiteText, () => ( props.websiteUrl)), () => ( action.url)),
    ...normalizedCaption
  };
};
    ...
    _markdowntojsx2.default,
    {
      options: {
        ...
        renderRule(next, node, renderChildren, state) {
          switch (node.type) {
            case _markdowntojsx.RuleType.image:
              return null;
            case _markdowntojsx.RuleType.gfmTask:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "mb-[0.125em] inline-block", children: node.completed ? "\u2705" : "\u2B1C" });
            case _markdowntojsx.RuleType.link:
              const sanitizedHref = _markdowntojsx.sanitizer.call(void 0, node.target);
              if (sanitizedHref) {
                return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                  LinkWithConfirm,
                  {
              ...
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { children: renderChildren(node.children, state) }, state.key);
            case _markdowntojsx.RuleType.heading:
            case _markdowntojsx.RuleType.paragraph:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "p", { className: "mb-[0.35em] last:mb-0", children: renderChildren(node.children, state) }, state.key);
            case _markdowntojsx.RuleType.blockQuote:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "blockquote", { className: "mb-[0.35em] last:mb-0", children: renderChildren(node.children, state) }, state.key);
            case _markdowntojsx.RuleType.codeBlock:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "pre", { className: "text-wrap", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "code", { children: node.text }) }, state.key);
            case _markdowntojsx.RuleType.orderedList:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "ol",
                {
                  className: "list-inside list-decimal [li>&]:ps-4",
                  children: node.items.map((item, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { children: renderChildren(item, state) }, index))
                },
                state.key
              );
            case _markdowntojsx.RuleType.unorderedList:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "ul",
                {
            ...
            case _markdowntojsx.RuleType.breakThematic:
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "hr", { className: "my-[0.5em]" }, state.key);
            default:
              return next();
          }
        }
...
var DialectLogo = (props) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 63,
...
var Button = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "button",
    {
      ...
      children: [
        children,
        isLink && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "absolute right-2 top-2", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          DeepLinkIcon,
          {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: _clsx2.default.call(void 0, isStandalone && "px-2"), children: [
          label && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "mb-1", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "label", { className: "text-subtext text-text-input block font-semibold", children: [
            label,
            required ? "*" : ""
          ] }) }),
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        ...
        finalDescription && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "div",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SimpleMarkdown, { text: finalDescription })
          }
        )
      ]
    }
...
var BaseInputContainer = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { children: [
    ...
    description && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "text-caption text-text-secondary peer-[:focus-within:has(:invalid)]:text-text-error mt-1.5 font-medium", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SimpleMarkdown, { text: description }) })
  ] });
};
      ...
      children: [
        ...
        description && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "span",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SimpleMarkdown, { text: description })
          }
        )
      ]
    }
...
var BaseBlinkLayout = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: _clsx2.default.call(void 0, "blink", themeClassMap[stylePreset]), children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "border-stroke-primary bg-bg-primary shadow-action w-full cursor-default overflow-hidden rounded-2xl border", children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "px-padding pb-padding pt-gap flex flex-col", children: [
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "mb-1.5 flex items-center gap-2", children: [
        websiteUrl && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "a",
          {
            ...
            rel: "noopener noreferrer",
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, LinkIcon, { className: "text-icon-primary group-hover:text-icon-primary-hover h-4 min-w-4 transition-colors motion-reduce:transition-none" }),
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-text-link group-hover:text-text-link-hover mt-[1px] block min-w-0 truncate transition-colors group-hover:underline motion-reduce:transition-none", children: _nullishCoalesce(websiteText, () => ( websiteUrl)) })
            ]
          }
        ),
        websiteText && !websiteUrl && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-subtext text-text-link min-w-0 truncate", children: websiteText }),
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "a",
          {
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-text text-text-primary mb-1 break-words font-semibold", children: title }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-subtext text-text-secondary mb-gap break-words", children: description && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SimpleMarkdown, { text: description }) }),
      !supportability.isSupported ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, NotSupportedBlock, { message: supportability.message }) : /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
        ...
        success && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-subtext text-text-success mt-between-inputs flex justify-center", children: success }),
        error && !success && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { className: "text-subtext text-text-error mt-between-inputs flex justify-center", children: error })
      ] }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "mt-4 flex justify-center", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, DialectLogo, {})
          ]
        }
      ) })
    ] })
...
var ActionContent = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "gap-between-inputs flex flex-col", children: [
    buttons && buttons.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "gap-between-buttons flex flex-wrap items-center", children: _optionalChain([buttons, 'optionalAccess', _53 => _53.map, 'call', _54 => _54((it, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      "div",
      {
